...
*/
public class InteractiveModels_R17 extends InteractiveAbstractClient_R17
{
   ...
   */
   public InteractiveModels_R17()
   {
      scene = new Scene("InteractiveModels_R17");
      ...
      scene.addPosition(new Position(new renderer.models_LP.PanelXY(-7, 7, -1, 3))); // wall
      scene.addPosition(new Position(new renderer.models_LP.PanelXZ(-7, 7, -3, 1))); // floor
      ...
      jf = new JFrame("Renderer 17 - Interactive Models");
