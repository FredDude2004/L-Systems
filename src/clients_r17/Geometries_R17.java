...
*/
      ...
      for (int k = 0; k < 360; ++k)
      {
         final Scene scene = new Scene("Geometries_R17_frame_"+k, camera);
         ...
         if (0 == k) DrawSceneGraph.draw(scene, "Geometries_R17_SG");

         // Render
         fb.clearFB();
         Pipeline.render(scene, fb);
         fb.dumpFB2File(String.format("PPM_Geometries_R17_Frame%03d.ppm", k));
       //fb.dumpFB2File(String.format("PNG_Geometries_R17_Frame%03d.png", k), "png");
      }
