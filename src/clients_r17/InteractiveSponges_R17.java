...
import renderer.models_TP.MengerSponge;
import renderer.models_TP.SierpinskiSponge;
...
*/
public class InteractiveSponges_R17 extends InteractiveAbstractClient_R17
{
   ...
   */
   public InteractiveSponges_R17()
   {
      scene = new Scene("InteractiveSponges_R17");

      // Create Model objects.
      scene.addPosition(new Position(new SierpinskiSponge(5)));
      scene.addPosition(new Position(PointCloud.make(new SierpinskiSponge(7))));
      scene.addPosition(new Position(new MengerSponge(3)));
      scene.addPosition(new Position(new SierpinskiTriangle(7)));
      scene.addPosition(new Position(PointCloud.make(new SierpinskiTriangle(9))));
      ...
      jf = new JFrame("Renderer 17 - Interactive Sponges");
   ...
   @Override protected void setTransformations(final char c)
   {
      ...
      {
         ModelShading.setRandomNestedModelColors(
                          scene.positionList.get(currentModel).getModel());
      }
      ...
      zSubRotation1 = false;
      zSubRotation2 = false;
      updateNestedMatrices(scene.getPosition(currentModel).getModel(), m);
   ...
   @Override protected void print_help_message()
   {
      ...
      System.out.println("Use the '/' and '?' keys to cycle forwards and backwards through the sponges.");
      System.out.println("Use the '>/<' keys to increase and decrease the depth of the sponge.");
      System.out.println("Use the 'i/I' keys to get information about the current model.");
      System.out.println("Use the 3/#, 4/$, 5/%, keys to rotate the sub-sponges around the x, y, z axes.");
      System.out.println("Use the '6' key to change the random solid sub-sponge colors.");
