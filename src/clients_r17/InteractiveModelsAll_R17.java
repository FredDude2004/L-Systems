...
*/
public class InteractiveModelsAll_R17 extends InteractiveAbstractClient_R17
{
   ...
   */
   public InteractiveModelsAll_R17()
   {
      scene = new Scene("InteractiveModelsAll_R17");
      ...
      scene.addPosition(new Position(
                           new BarycentricTriangle(45, 4)));
      // fractals
      scene.addPosition(new Position(new SierpinskiTriangle(7)));
      scene.addPosition(new Position(new SierpinskiSponge(6)));
      ...
      scene.addPosition(new Position(new Tetrahedron(20, 20)));
      scene.addPosition(new Position(new Octahedron()));
      scene.addPosition(new Position(new Octahedron(30)));
      scene.addPosition(new Position(new Octahedron(20, 20)));
      ...
      jf = new JFrame("Renderer 17 - All Models");
