...
public class Geometries_R18
{
   ...
   public static void main(String[] args)
   {
    ...
    //final Texture texture = new Texture(assets + "textures/uv_grid_128.ppm");
      ...
      final Model xzPlane = new renderer.models_F.PanelXZ(-6, 6, -7, 7);
...
*/
      ...
      for (int k = 0; k < 360; ++k)
      {
         final Scene scene = new Scene("Geometries_R18_frame_"+k, camera);
         ...
         if (0 == k) DrawSceneGraph.draw(scene, "Geometries_R18_SG");

         // Render
         fb.clearFB();
         Pipeline.render(scene, fb);
         fb.dumpFB2File(String.format("PPM_Geometries_R18_Frame%03d.ppm", k));
       //fb.dumpFB2File(String.format("PNG_Geometries_R18_Frame%03d.png", k), "png");
      }
