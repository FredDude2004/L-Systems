   ...
   */
   public SolarSystem()
   {
      ...
      */
      ...
      final Texture planetTex = new Texture(assets + "textures/planets/earth2.ppm");
      final Texture moonTex = new Texture(assets + "textures/planets/pluto.ppm");

      // Create the sun.
      final Model sun = new Sphere(sunTex, 1.0, 10, 10);
      ...
      jf = new JFrame("Renderer 18 - Solar System Scene");
