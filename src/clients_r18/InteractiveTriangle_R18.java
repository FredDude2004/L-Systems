...
*/
public class InteractiveTriangle_R18 extends InteractiveAbstractClient_R18
{
   ...
   */
   public InteractiveTriangle_R18()
   {
      // Create the Scene object that we shall render.
      scene = new Scene("InteractiveTriangle_R18");
      ...
      // Create textures for the triangle.
      final Texture texture1 = new Texture(assets + "textures/wood.ppm");
      final Texture texture2 = new Texture(assets + "textures/Yoda.ppm");
      final Texture texture = texture2;
      ...
      // Add geometry with color and texture to the Model.
      model.addPrimitive(new Triangle(0, 1, 2, // vertices
                                      0, 1, 2, // front face colors
      ...
      DrawSceneGraph.draw(scene, "InteractiveTriangle_R18_SG");
      ...
      jf = new JFrame("Renderer 18 - Interactive Triangle");
