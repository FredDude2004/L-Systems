...
import renderer.models_Tex.*; // models defined using higher order triangle primitives
...
*/
public class InteractiveModels_R18 extends InteractiveAbstractClient_R18
{
   ...
   */
   public InteractiveModels_R18()
   {
      ...
      final Texture texture3 = new Texture(assets + "textures/brick1.ppm");
      final Texture texture4 = new Texture(assets + "textures/brick2.ppm");
      final Texture texture5 = new Texture(assets + "textures/wood.ppm");
      final Texture texture6 = new Texture(assets + "textures/wall.ppm");

      scene = new Scene("InteractiveModels_R18");

      // Create several Model objects.
      scene.addPosition(new Position(new Icosidodecahedron(texture1)));
      scene.addPosition(new Position(new ObjSimpleModel(texture5,
                             new File(assets + "galleon.obj"))));
      scene.addPosition(new Position(new ObjSimpleModel(texture1,
                             new File(assets + "teapot.obj"))));
      scene.addPosition(new Position(new ObjSimpleModel(texture1,
                             new File(assets + "cessna.obj"))));
      scene.addPosition(new Position(new Sphere(texture1, 1.0, 30, 30)));
      scene.addPosition(new Position(new Cylinder(texture1, texture2, texture2, 0.5, 1.0, 20, 20)));
      scene.addPosition(new Position(new Torus(texture1, 0.75, 0.25, 25, 25)));
      scene.addPosition(new Position(new Cube(texture1, "cube").transform(Matrix.scale(.75,.75,.75))));
      scene.addPosition(new Position(new PanelXY(texture3, -7, 7, -1, 3))); // wall
      scene.addPosition(new Position(new PanelXZ(texture6, -7, 7, -3, 1))); // floor
      scene.addPosition(new Position(new renderer.models_F.ObjSimpleModel(  // airplane
                             new File(assets + "cessna.obj"))));
      ...
      jf = new JFrame("Renderer 18 - Interactive Models");
