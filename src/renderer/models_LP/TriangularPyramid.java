...
public class TriangularPyramid extends Model implements MeshMaker
{
   ...
   */
   public TriangularPyramid(final double r, final double h)
   {
      ...
      addPrimitive(new LineLoop(0, 1, 2),    // bottom face
                   new LineFan(3, 0, 1, 2)); // three edges
   }
   ...
   */
                            ...
                            final int n, final int k)
   {
      ...
      final Primitive botFan = new LineFan(),
                      topFan = new LineFan();
      ...
      for (int j = 0; j < k; ++j)
      {
         ...
         botFan.addIndex(index+0,
                         index+1,
                         index+2);
         topFan.addIndex(index+0,
                         index+1,
                         index+2);
/*
         addLineStrip(apexIndex, index+0, centerIndex); // first side
         addLineStrip(apexIndex, index+1, centerIndex); // second side
         addLineStrip(apexIndex, index+2, centerIndex); // third side
*/
         index += 3;
      }
      addPrimitive(botFan,
      ...
      for (int i = 0; i < n; ++i)
      {
         ...
         addPrimitive(new LineLoop(index+0, index+1, index+2));
