...
public class Pyramid extends Model implements MeshMaker
{
   ...
   */
   public Pyramid(final double s, final double h)
   {
      ...
      addPrimitive(new LineLoop(0, 1, 2, 3),    // base
                   new LineFan(4, 0, 1, 2, 3)); // 4 sides
   }
   ...
   */
                  ...
                  final boolean grid)
   {
      ...
      for (int j = 0; j < k + 1; ++j)
      {
         ...
         addPrimitive(new LineLoop(apexIndex, index+0, index+1));
         index += 2;
      }
      ...
      for (int i = 0; i < n; ++i)
      {
         ...
         addVertex(new Vertex( s, h,  s),
                   ...
                   new Vertex(-s, h, -s),
                   new Vertex(-s, h,  s));
         addPrimitive(new LineLoop(index+0, index+1, index+2, index+3));
         s -= deltaS;
         index += 4;
      }
   }
