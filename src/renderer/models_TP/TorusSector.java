...
/**
   Create a solid model of a partial torus.
<p>
...
<p>
   ...
   @see SphereSector
*/
public class TorusSector extends Model implements MeshMaker_TP
{
   ...
   */
   ...
   <p>
      ...
      @param theta1  beginning longitude angle for the circle of revolution (in radians)
      @param theta2  ending longitude angle for the circle of revolution (in radians)
   ...
   */
   public TorusSector(final double r1,     final double r2,
                      ...
                      final int n, final int k)
   {
      this(r1, r2, theta1, theta2, phi1, phi2, n, k, MeshType.HORIZONTAL);
   }
   ...
   */
   public TorusSector(final double r1, final double r2,
                      ...
                      final MeshType type)
   {
      this(r1, r2, theta1, theta2, 0, 2*Math.PI, n+1, k, type);
   }
   ...
   <p>
      ...
      @param theta1  beginning longitude angle for the circle of revolution (in radians)
      @param theta2  ending longitude angle for the circle of revolution (in radians)
      @param phi1    beginning latitude angle for the cross section circle (in radians)
      @param phi2    ending latitude angle for the cross section circle (in radians)
      @param n       number of circles of latitude
      @param k       number of circles of longitude
      @param type  choose between striped and checkerboard triangle strips
      @throws IllegalArgumentException if {@code n} is less than 4
   ...
   */
   ...
   @Override
   public TorusSector remake(final int n, final int k, final MeshType type)
   {
