...
/**
   Create a solid model of a Sierpinski Sponge centered at the origin.
<p>
   ...
   */
   public SierpinskiSponge(final int n)
   {
      ...
      if (0 == n)
      {
         ...
         addPrimitive(new TriangleStrip(0, 1, 2, 3, 0, 1));
      }
      else
      {
   ...
   */
                            ...
                            final int pmX, final int pmY, final int pmZ)
   {
      ...
      if (0 == n) // stop the recursion
      {
         ...
         // Create four triangular faces.
         model.addPrimitive(new TriangleStrip(0, 1, 2, 3, 0, 1));
      }
      else
      {
