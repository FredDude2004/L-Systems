...
/**
   Create a solid model of a ring (an annulus)
...
<p>
   ...
   @see RingSector
*/
public class Ring extends Model implements MeshMaker_TP
{
   ...
   */
   ...
   {
      this(r1, r2, n, k, MeshType.HORIZONTAL);
   }
   ...
   */
   ...
   @Override
   public Ring remake(final int n, final int k, final MeshType type)
   {
