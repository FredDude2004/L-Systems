...
/**
   Create a textred model of a icosidodecahedron
...
public class Icosidodecahedron extends Model
{
   ...
   */
   public Icosidodecahedron(final Texture texture)
   {
      ...
      addPrimitive(
                   //new Face( 0,  2,  7, 10,  3),
                   new Triangle( 0,  2,  7, 2, 1, 0, 0),
                   new Triangle( 0,  7,  3, 2, 0, 3, 0),
                   new Triangle( 7, 10,  3, 0, 4, 3, 0),

                   //new Face( 0,  4, 11,  6,  1),
                   new Triangle( 0,  4, 11, 2, 1, 0, 0),
                   new Triangle( 0, 11,  1, 2, 0, 3, 0),
                   new Triangle(11,  6,  1, 0, 4, 3, 0),

                   //new Face( 1,  5, 14,  8,  2),
                   new Triangle( 1,  5, 14, 2, 1, 0, 0),
                   new Triangle( 1, 14,  2, 2, 0, 3, 0),
                   new Triangle(14,  8,  2, 0, 4, 3, 0),

                   //new Face( 3,  9, 19, 12,  4),
                   new Triangle( 3,  9, 19, 2, 1, 0, 0),
                   new Triangle( 3, 19,  4, 2, 0, 3, 0),
                   new Triangle(19, 12,  4, 0, 4, 3, 0),

                   //new Face( 5,  6, 15, 22, 13),
                   new Triangle( 5,  6, 15, 2, 1, 0, 0),
                   new Triangle( 5, 15, 13, 2, 0, 3, 0),
                   new Triangle(15, 22, 13, 0, 4, 3, 0),

                   //new Face( 7,  8, 17, 25, 16),
                   new Triangle( 7,  8, 17, 2, 1, 0, 0),
                   new Triangle( 7, 17, 16, 2, 0, 3, 0),
                   new Triangle(17, 25, 16, 0, 4, 3, 0),

                   //new Face( 9, 10, 16, 24, 18),
                   new Triangle( 9, 10, 16, 2, 1, 0, 0),
                   new Triangle( 9, 16, 18, 2, 0, 3, 0),
                   new Triangle(16, 24, 18, 0, 4, 3, 0),

                   //new Face(11, 12, 20, 23, 15),
                   new Triangle(11, 12, 20, 2, 1, 0, 0),
                   new Triangle(11, 20, 15, 2, 0, 3, 0),
                   new Triangle(20, 23, 15, 0, 4, 3, 0),

                   //new Face(13, 21, 26, 17, 14),
                   new Triangle(13, 21, 26, 2, 1, 0, 0),
                   new Triangle(13, 26, 14, 2, 0, 3, 0),
                   new Triangle(26, 17, 14, 0, 4, 3, 0),

                   //new Face(18, 27, 28, 20, 19),
                   new Triangle(18, 27, 28, 2, 1, 0, 0),
                   new Triangle(18, 28, 19, 2, 0, 3, 0),
                   new Triangle(28, 20, 19, 0, 4, 3, 0),

                   //new Face(21, 22, 23, 28, 29),
                   new Triangle(21, 22, 23, 2, 1, 0, 0),
                   new Triangle(21, 23, 29, 2, 0, 3, 0),
                   new Triangle(23, 28, 29, 0, 4, 3, 0),

                   //new Face(24, 25, 26, 29, 27),
                   new Triangle(24, 25, 26, 2, 1, 0, 0),
                   new Triangle(24, 26, 27, 2, 0, 3, 0),
                   new Triangle(26, 29, 27, 0, 4, 3, 0));
   }
}//Icosidodecahedron
