...
/**
   Create a textured model of a partial torus.
<p>
...
public class TorusSector extends Model implements MeshMaker
{
   ...
   /**
      Create a partial textured torus with half the circle of revolution with radius 3/4
   ...
   */
   public TorusSector(final Texture texture)
   {
      this(texture, 0.75, 0.25, Math.PI/2, 3*Math.PI/2, Math.PI, 2*Math.PI, 6, 8);
   }


   /**
      Create a partial textured torus with a partial circle of revolution
   ...
   */
   ...
   {
      this(texture, r1, r2, theta1, theta2, 0, 2*Math.PI, n+1, k);
   }


   /**
      Create a partial textured torus with a partial circle of revolution with
   ...
   */
   ...
   {
      return new TorusSector(this.texture,
                             this.r1,     this.r2,
