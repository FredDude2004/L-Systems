...
/**
   Create a textured model of a partial sphere centered at the origin
<p>
...
public class SphereSector extends Model implements MeshMaker
{
   ...
   /**
      Create half of a textured sphere of radius 1 centered at the origin.

      @param texture  {@link Texture} to use with this {@link Model}
   */
   public SphereSector(final Texture texture)
   {
      this(texture, 1, Math.PI/2, 3*Math.PI/2, 15, 8);
   }


   /**
      Create a part of the textured sphere of radius r centered at the origin.
   <p>
   ...
   */
   ...
   {
      this(texture, r, theta1, theta2, 0, Math.PI, n+2, k);
   }
   ...
   */
   ...
   {
      return new SphereSector(this.texture,
                              this.r,
