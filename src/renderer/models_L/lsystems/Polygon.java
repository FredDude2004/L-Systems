...
public class Polygon extends Model {
    /**
      ...
      @param s the {@link Turtle2D} instructions to draw the polygon
      @throws NullPointerException
     */
    public Polygon(final String s, final double delta) {
	this(s, delta, Color.black);
    }
    ...
    /**
      ...
      @param c
    */
    public Polygon(final String s, double delta, final Color c) {
	this(s, 1.0, delta, c, c, c);
    }
    ...
    /**
      ...
      @param c
      */
    public Polygon(String s, double stepSize, double delta, Color c) {
	this(s, stepSize, delta, c, c, c);
    ...
    /**
      ...
      @param c3
    */
    public Polygon(final String s, double delta, final Color c1, final Color c2, final Color c3) {
	this(s, 1.0, delta, c1, c2, c3);
    }
    ...
    /**
      ...
      @param c3
    */
    public Polygon(String s, double stepSize, double delta, Color c1, Color c2, Color c3) {
	PolygonResult res = buildPolygonWithTurtle2D(s, stepSize, delta, c1, c2, c3);
    }

   /**
     Check if a {@link Model} is a {@code Polygon} triangulate it and return a filled
     closed {@code Polygon}
   ...
   */
    ...
    public PolygonResult buildPolygonWithTurtle2D(String s, double stepSize, double delta,
	...
	while (success) {
	    ...
	    if (!res.success) {
		err = "Failed to triangulate: " + res.errorMessage;
		success = false;
	    }
     ...
     * TriangulateResult
     * @param success
     * @param triangles an array of integer indices representing the {@code Vertex}'s that make up each triangle three at a time.
     * @param errorMessage
     */
    ...
    /**
      ...
      Triangulates the {@link Model} using the Ear-Clipping algorithm
    */
    public TriangulateResult triangulateWithEarClipping(Vertex[] vertices) {
	boolean success = true;
	int[] triangles = null;
	String err = "";
	...
	while (success) {
	    ...
	    //    PolygonHelpers.ComputePolygonArea(vertices, out float area, out WindingOrder windingOrder);
	    //
