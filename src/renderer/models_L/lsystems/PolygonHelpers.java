...
public class PolygonHelpers {
    ...
    */
    ...
    /**
      ...
      If the {@link Model} is a set of vertices in 3D space, we check if they lie on a single plane.
  
      Choose Three Vertices: Select any three non-collinear vertices from the set. These three points define a plane.
      Plane Equation: Calculate the equation of the plane defined by these three points.
      Test Remaining Vertices: For every other vertex in the set, substitute its coordinates into the plane equation. 
      If all other vertices satisfy the plane equation (within a small tolerance for floating-point precision), 
    ...
    */
    ...
    /**
     * @param vertices
     * @return an ArrayList of {@code Vertex} of the vertices list in 2D coordinates.
    */
