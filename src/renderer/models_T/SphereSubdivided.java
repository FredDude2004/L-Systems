...
public class SphereSubdivided extends Model implements MeshMaker
{
   ...
   */
   ...
   {
      super(String.format("Sphere_Subdivided(%d)", n));
   ...
   */
                    ...
                    final boolean sierpinski)
   {
      ...
      if (0 == n)
      {
         ...
         addVertex(v0, v1, v2);
         addPrimitive(new Triangle(index+0, index+2, index+1)); // v0, v2, v1
      }
      else
      {
   ...
   @Override
   public SphereSubdivided remake(final int n, final int k)
   {
      final int newN;
      if (n != this.n)
         newN = n;
         ...
         newN = k;
      return new SphereSubdivided(newN);
   }
}//SphereSubdivided
