   ...
   */
   public Cube3(int xCount, int yCount, int zCount)
   {
      ...
      for (int i = 0; i < xCount; ++i)
      {
         ...
         addPrimitive(new Triangle(index-4, cFront, index+0),
                      new Triangle(index-3, index+1, cFront));
         // back face, top and bottom edges
         addPrimitive(new Triangle(index-2, index+2, cBack),
                      new Triangle(index-1, cBack, index+3));
         // top face, front and back edges
         addPrimitive(new Triangle(index-4, index+0, cTop),
                      new Triangle(index-2, cTop, index+2));
         // bottom face, front and back edges
         addPrimitive(new Triangle(index-3, cBottom, index+1),
                      new Triangle(index-1, index+3, cBottom));
         index += 4;
      }
      ...
      for (int i = 0; i < yCount; ++i)
      {
         ...
         addPrimitive(new Triangle(index-4, index+0, cFront),
                      new Triangle(index-3, cFront,  index+1));
         // back face, right and left edges
         addPrimitive(new Triangle(index-2, cBack,   index+2),
                      new Triangle(index-1, index+3, cBack));
         // right face, front and back edges
         addPrimitive(new Triangle(index-4, rCenter, index+0),
                      new Triangle(index-2, index+2, rCenter));
         // left face, front and back edges
         addPrimitive(new Triangle(index-3, index+1, lCenter),
                      new Triangle(index-1, lCenter, index+3));
         index += 4;
      }
      ...
      for (int i = 0; i < zCount; ++i)
      {
         ...
         addPrimitive(new Triangle(index-4, cTop, index+0),
                      new Triangle(index-3, index+1, cTop));
         // bottom face, right and left edges
         addPrimitive(new Triangle(index-2, index+2, cBottom),
                      new Triangle(index-1, cBottom, index+3));
         // right face, top and bottom edges
         addPrimitive(new Triangle(index-4, index+0, rCenter),
                      new Triangle(index-2, rCenter, index+2));
         // left face, top and bottom edges
         addPrimitive(new Triangle(index-3, lCenter, index+1),
                      new Triangle(index-1, index+3, lCenter));
         index += 4;
      }
   }
}//Cube3
