   ...
   */
   public SolarSystem()
   {
      ...
      */
      ...
      jf = new JFrame("Renderer 14 - Solar System Scene");
...
//      System.out.println(scene);
   ...
   private void setupViewing()
   {
      ...
      planetMoon_p.getModel().setBackFaceCulling(doBackFaceCulling);
      planetMoon_p.getModel().setFrontFacingIsCCW(frontFacingIsCCW);
      planetMoon_p.getModel().setFacesHaveTwoSides(facesHaveTwoSides);
