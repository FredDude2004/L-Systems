...
import renderer.models_F.*; // models defined using higher order line primitives
...
*/
public class Geometries_R14_navigate implements
                                     KeyListener,
                                     ComponentListener,
                                     ActionListener
{
   ...
   */
   public Geometries_R14_navigate()
   {
      ...
      ModelShading.setBackFaceColor(model[3][0], backFaceColor);
      ...
      ModelShading.setBackFaceColor(model[3][1], backFaceColor);
      ...
      jf = new JFrame("Renderer 14 - Geometries navigate");
   ...
   private void setupViewing()
   {
      ...
      final Scene scene = new Scene("Geometries_R14_navigate_angle_"+angleNumber, camera);
      scene.debug = debug;
      ...
      if (0 == angleNumber) DrawSceneGraph.draw(scene, "Geometries_R14_navigate_SG");
