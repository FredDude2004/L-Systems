...
*/
public class TwoInteractiveModels_R14 extends InteractiveAbstractClient_R14
{
   ...
   */
   public TwoInteractiveModels_R14()
   {
      scene = new Scene("TwoInteractiveModels_R14");
      ...
      DrawSceneGraph.draw(scene, "TwoInteractiveModels_R14_SG");
      ...
      jf = new JFrame("Renderer 14 - Two Interactive Models");
