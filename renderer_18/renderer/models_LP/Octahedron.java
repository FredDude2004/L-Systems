...
*/
      ...
      addPrimitive(new LineLoop(0, 1, 2, 3),    // the center plane
                   new LineFan(4, 0, 1, 2, 3),  // line fan from the top
                   new LineFan(5, 0, 1, 2, 3)); // line fan from the bottom
   }
...
*/
   ...
   */
   private void fan(final int n, final int v0, final Vertex v1,
                                               ...
                                               final Vertex v4)
   {
      final LineFan lineFan1 = new LineFan();
      ...
      addPrimitive(lineFan1);

      final LineFan lineFan2 = new LineFan();
      ...
      addPrimitive(lineFan2);

      final LineFan lineFan3 = new LineFan();
      ...
      addPrimitive(lineFan3);

      final LineFan lineFan4 = new LineFan();
