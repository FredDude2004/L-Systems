...
public class Tetrahedron extends Model implements MeshMaker
{
   ...
   */
   public Tetrahedron(final boolean dual)
   {
      ...
      addPrimitive(new Face(0, 1, 3),  // top edge
                   new Face(1, 0, 2),
                   new Face(3, 2, 0),  // bottome edge
                   new Face(2, 3, 1));
   }
   ...
   */
   public Tetrahedron(final int m0, final int m1, final int m2, final int m3)
   {
      ...
      fan(m0, 0,  3, 2, 1); // fan out from v0
      fan(m1, 1,  0, 2, 3); // fan out from v1
      fan(m2, 2,  3, 1, 0); // fan out from v2
      fan(m3, 3,  0, 1, 2); // fan out from v3
   }
