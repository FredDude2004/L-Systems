...
/**
   Create a solid model of a right circular cylinder
...
<p>
   ...
   @see CylinderSector
*/
public class Cylinder extends Model implements MeshMaker_TP
{
   ...
   */
   ...
   @Override
   public Cylinder remake(final int n, final int k, final MeshType type)
   {
      return new Cylinder(this.r, this.h,
                          n, k,
                          type);
   }
}//Cylinder
