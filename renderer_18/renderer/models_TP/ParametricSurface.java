...
/**
   Create a solid model of a parametric surface in space.
<p>
   ...
   @see ParametricCurve
*/
public class ParametricSurface extends Model implements MeshMaker_TP
{
   ...
   */
   public ParametricSurface(final DoubleBinaryOperator f,
                            ...
                            final MeshType type)
   {
      this((x,z) -> x, f, (x,z) -> z, x1, x2, z1, z2, n, k, type);
   }
   ...
   */
   public ParametricSurface(final DoubleBinaryOperator x,
                            ...
                            final int n, final int k)
   {
      this(x, y, z, s1, s2, t1, t2, n, k, MeshType.HORIZONTAL);
   }
   ...
   */
   public ParametricSurface(final DoubleBinaryOperator x,
                            ...
                            final MeshType type)
   {
      this(x, y, z, s1, s2, t1, t2, n, k, type,
   ...
   */
                            ...
                            String name)
   {
      ...
      // An array of vertices to be used to create the triangles.
   ...
   @Override
   public ParametricSurface remake(final int n, final int k, final MeshType type)
   {
