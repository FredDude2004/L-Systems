...
/**
   Create a textured model of a regular icosahedron
...
public class Icosahedron extends Model
{
   ...
   */
   public Icosahedron(final Texture texture)
   {
      super("Icosahedron");
...
*/
      ...
      // https://github.com/mrdoob/three.js/blob/master/src/geometries/IcosahedronGeometry.js
      // Working, more or less, from the top down, front to back.
      addPrimitive(new Triangle(0,  5,  1, 0, 1, 2, 0),
                   new Triangle(0,  1,  7, 0, 1, 2, 0),
                   new Triangle(0, 11,  5, 0, 1, 2, 0),
                   new Triangle(0,  7, 10, 0, 1, 2, 0),
                   new Triangle(0, 10, 11, 0, 1, 2, 0),
                   new Triangle(1,  5,  9, 0, 1, 2, 0),
                   new Triangle(1,  8,  7, 0, 1, 2, 0),
                   new Triangle(1,  9,  8, 0, 1, 2, 0),
                   new Triangle(4,  5, 11, 0, 1, 2, 0),
                   new Triangle(6, 10,  7, 0, 1, 2, 0),
                   new Triangle(4,  9,  5, 0, 1, 2, 0),
                   new Triangle(6,  7,  8, 0, 1, 2, 0),
                   new Triangle(2, 11, 10, 0, 1, 2, 0),
                   new Triangle(3,  8,  9, 0, 1, 2, 0),
                   new Triangle(2,  4, 11, 0, 1, 2, 0),
                   new Triangle(2, 10,  6, 0, 1, 2, 0),
                   new Triangle(3,  9,  4, 0, 1, 2, 0),
                   new Triangle(3,  6,  8, 0, 1, 2, 0),
                   new Triangle(2,  3,  4, 0, 1, 2, 0),
                   new Triangle(2,  6,  3, 0, 1, 2, 0));
   }
}//Icosahedron
