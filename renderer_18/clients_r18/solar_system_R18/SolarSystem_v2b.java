...
import renderer.models_Tex.Sphere;
...
*/
public class SolarSystem_v2b implements ActionListener, KeyListener, ComponentListener
{
   ...
   */
   public SolarSystem_v2b()
   {
      /*
         See the above picture of the tree that this code creates.
      */
      scene = new Scene("Solar System 2b",
                        Camera.projPerspective());
      scene.camera.viewTranslate(0, 0, 8);

      final Texture sunTex = new Texture(assets + "textures/planets/sun.ppm");
      final Texture planetTex = new Texture(assets + "textures/planets/earth.ppm");
      final Texture moonTex = new Texture(assets + "textures/planets/pluto.ppm");
      ...
      // Create the sun.
      final Model sun = new Sphere(sunTex, 1.0, 16, 16);
      ...
      // Create the planet.
      final Model planet = new Sphere(planetTex, 0.5, 10, 10);
      ...
      // Create the moon.
      final Model moon = new Sphere(moonTex, 0.2, 10, 10);
      ModelShading.setPrimitiveColorShaded(moon, Color.gray);
      ...
      DrawSceneGraph.draw(scene, "SolarSystem_v2b_SG");
      DrawSceneGraph.drawMatrixDetails = true;
      DrawSceneGraph.draw(scene, "SolarSystem_v2b_SG_with_Matrices");
      ...
      jf = new JFrame("Renderer 18 - Solar System Scene v2b");
